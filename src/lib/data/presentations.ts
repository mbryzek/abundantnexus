...
export const presentations: Presentation[] = [
	...
	},
	{
		...
		isKeynote: true,
		speakers: [
			{ name: 'Sandeep Akkaraju', description: 'Exo CEO & Co-Founder', slug: 'akkaraju-sandeep' },
		],
	},
	{
		...
		speakers: [
			{ name: 'Prof. David Horsley', description: 'Northeastern University', slug: 'david-horsley' },
		],
	},
	{
		...
		speakers: [
			{
				...
				description:
					'XPRIZE Founder & Co-Author of the New York Times Bestseller Abundance: The Future Is Better Than You Think',
	...
	},
	{
		...
		speakers: [
			{ name: 'Curtis Ray', description: 'Biz Dev at Omnitron Sensors', slug: 'ray-curtis' },
		],
	},
	{
